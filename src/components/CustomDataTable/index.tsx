          ...
          <FormProvider {...methods}>
            ...
            >
              <section className="field-containers w-full grid grid-cols-[repeat(auto-fit,minmax(350px,1fr))] gap-4">
                <Controller
                  label="State Name (in Local language)"
                  required={true}
                  name="stateNameLl"
                  type="text"
                  placeholder="Please enter State name in Local language"
                />
                <Controller
                  label="State Name (in English language)"
                  required={true}
                  name="stateName"
                  type="text"
                  placeholder="Please enter State name in English"
                />
                <Controller
                  ...
                  name="stateShortName"
                  type="text"
                  placeholder="Please enter State short name"
                />
                <Controller
                  label="State code (3 digit)"
                  required={true}
                  name="code"
                  type="text"
                  placeholder="Please enter State short name"
                ...
                />
                <Controller
                  label="Mobile FPS Available"
                  required={true}
                  name="availableFpsMobile"
                  type="radio"
                  options={[
                    { label: 'Yes', value: true },
                    { label: 'No', value: false },
                ...
                />
                <Controller
                  label="Central PGRMS State"
                  required={true}
                  name="centralPgrmsState"
                  type="radio"
                  options={[
                    { label: 'Yes', value: true },
                    { label: 'No', value: false },
