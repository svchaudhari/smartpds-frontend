      ...
      >
        <div className="model-content-container relative">
          ...
          <h2 className="mt-2 text-[1.5rem] font-bold">
            Sub-District Management System
          </h2>
          <FormProvider {...methods}>
            ...
            >
              <section className="field-containers w-full grid grid-cols-[repeat(auto-fit,minmax(350px,1fr))] gap-4">
                <Controller
                  label="SubDistrict Name (in Local language)"
                  required={true}
                  name="districtNameLl"
                  type="text"
                  placeholder="Please enter SubDistrict name in Local language"
                />
                <Controller
                  label="SubDistrict Name (in English language)"
                  required={true}
                  name="districtName"
                  type="text"
                  placeholder="Please enter SubDistrict name in English"
                />
                <Controller
                  label="SubDistrict Language Code"
                  required={true}
                  name="subDistLgdCode"
                  type="text"
                  placeholder="Please enter SubDistrict Language Code"
                />
                <Controller
                  label="State ID"
                  required={true}
