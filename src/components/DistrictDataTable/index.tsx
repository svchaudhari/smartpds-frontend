          ...
          <FormProvider {...methods}>
            ...
            >
              <section className="field-containers w-full grid grid-cols-[repeat(auto-fit,minmax(350px,1fr))] gap-4">
                <Controller
                  label="District Name (in Local language)"
                  required={true}
                  name="districtNameLl"
                  type="text"
                  placeholder="Please enter District name in Local language"
                />
                <Controller
                  label="District Name (in English language)"
                  required={true}
                  name="districtName"
                  type="text"
                ...
                />
                <Controller
                  label="District Language Code"
                  required={true}
                  name="distLgdCode"
                  type="text"
                  placeholder="Please enter District Language Code"
                />
                <Controller
                  label="State ID"
                  required={true}
